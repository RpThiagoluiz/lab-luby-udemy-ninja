...
*/
  console.log(
    `O resultado da soma é: ${sum((numberA, numberB) => numberA + numberB)}` //O resultado da soma é: 8
  );
...
*/
  const subtraction = calculator(29, 2);
  const multiplication = calculator(15, 2);
  const division = calculator(8, 2);
  const mod = calculator(17, 2);
...
*/
  ...
  console.log(
    `O resultado da multiplicação é: ${multiplication(
      (numberA, numberB) => numberA * numberB
    )}`
  );

  console.log(
    `O resultado da divisão é: ${division(
      (numberA, numberB) => numberA / numberB
    )}`
  );

  console.log(
    `O resto da divisão é: ${mod((numberA, numberB) => numberA % numberB)}`
  );
})();
