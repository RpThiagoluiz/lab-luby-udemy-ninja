...
*/
  let email = win.prompt("Qual seu email?");
...
*/
  $button.addEventListener(
    ...
    (event) => {
      ...
      if (!$inputUsername.value) win.alert("Preencha o nome do usuário!");
      else if (!$inputEmail.value) win.alert("Preencha o e-mail!");
      else if (!$message.value) win.alert("Preencha a mensagem!");
...
*/
  ...
  console.log(isValidEmail("meu.email+categoria@gmail.com"));
})(window, document);
